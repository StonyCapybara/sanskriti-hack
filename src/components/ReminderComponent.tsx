...
export default function ReminderComponent() {
    ...
    {reminders.map(({ name, date }, idx) => (
        ...
        <div className="select-none cursor-pointer bg-[#844C697F] transition duration-200 hover:bg-[#844C69] text-xl m-auto w-fit mx-auto text-center p-4 px-8 rounded-xl font-oxanium text-[#FEE3D8] mt-4" onClick={()=>setReminders(prev => [...reminders, {"name": "Math Lecture", "date": "6th October, 10:00AM"}])}>
            ADD REMINDER
        </div>
    </>
